class FoodSearchesController < ApplicationController
  ...
  def index
    ...
    respond_to do |format|
      format.turbo_stream { render template: "food_searches/new", locals: { foods: @foods, daily_log_id: params[:daily_log_id], user_id: current_user.id } }
      format.html{ render template: "food_searches/new", locals: { foods: @foods, daily_log_id: params[:daily_log_id], user_id: current_user.id } }
    end
  end
end
